...
<head>
    ...
    <style>
        ...
        th, td { border: 1px solid #e2e8f0; padding: 12px 10px; text-align: center; font-size: 14px; word-wrap: break-word; word-break: break-word; }
        
        /* ĐỘ RỘNG CỐ ĐỊNH CHO CÁC CỘT */
        .col-buoi { width: 75px; }
        .col-tiet { width: 115px; font-weight: normal; } 
