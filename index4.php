...
<head>
    ...
    <style>
        ...
        .tab-btn.active[data-target="2"] { background: #17a2b8; color: white; box-shadow: 0 4px 6px rgba(23,162,184,0.2); }
        ...
        /* SỬA MÀU NỀN TOÀN KHUNG ĐẬM HƠN THEO YÊU CẦU */
        /* Bé 1: Trâm Anh - Màu Xanh Lá đậm hơn */
        .kid-1-title { background: #d4edda !important; border: 2px solid #218838; }
        /* Bé 2: Thành Phát - Màu Xanh Lục đậm hơn */
        .kid-2-title { background: #d1ecf1 !important; border: 2px solid #117a8b; }
        ...
        @media (max-width: 768px) {
            ...
            /* ÉP ĐỘ RỘNG CÁC CỘT THỨ BẰNG CỘT TIẾT (115px) TRÊN ĐIỆN THOẠI */
...
<body>
    <div class="container">
        ...
        $kids = [
            ...
            '2' => ['ten' => 'THÀNH PHÁT 9/3', 'color' => '#17a2b8', 'bg_class' => 'kid-2-title']
        ];
