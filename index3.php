...
<head>
    ...
    <style>
        ...
        thead th { 
            ...
            z-index: 10; 
            padding: 12px 10px; 
            font-weight: 700; /* Tiêu đề bảng đậm rõ ràng */
            font-size: 14px;
            color: white !important;
        }
        
        /* Cải tiến: Tăng độ đậm mặc định (font-weight: 500) cho toàn bộ nội dung ô trong bảng */
        th, td { border: 1px solid #e2e8f0; padding: 12px 10px; text-align: center; font-size: 14px; font-weight: 500; word-wrap: break-word; word-break: break-word; }
        
        /* ĐỘ RỘNG CỐ ĐỊNH CHO CÁC CỘT */
        .col-buoi { width: 75px; font-weight: 700; } /* Cột buổi giữ chữ đậm hẳn */
        .col-tiet { width: 115px; font-weight: 500; } /* Cột tiết đồng bộ độ đậm 500 */
